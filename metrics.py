...
def evaluate_classification(
    ...
    # Extract metrics - use weighted average for better representation
    ...
    metrics = {
        ...
        "Precision_Up": report.get("1", {}).get("precision", 0.0),  # Class 1 (up) precision
        "Recall_Up": report.get("1", {}).get("recall", 0.0),  # Class 1 (up) recall
        "F1_Up": report.get("1", {}).get("f1-score", 0.0),  # Class 1 (up) F1
